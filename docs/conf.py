...
"""
quadrics documentation build configuration file
"""
...
latex_documents = [
    (master_doc, 'quadrics.tex', 'quadrics Documentation',
...
# ###################################################################
man_pages = [
    (master_doc, 'quadrics', 'quadrics Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'quadrics', 'quadrics Documentation',
     author, 'quadrics', 'One line description of project.',
     'Miscellaneous'),
]
